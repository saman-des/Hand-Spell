...
while True:
    ...
    #Time to configure the hand specifically into the ROI...
        ...
        cv2.putText(frame_copy, "Record gesture for letter: " + str(element), (200, 400), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
...
#                 cv2.imwrite(r"D:\\gesture\\x"+"\\" + str(num_imgs_taken) + '.jpg', thresholded)
                img_name = 'gesture/train/1/1{}.png'.format(num_imgs_taken)
